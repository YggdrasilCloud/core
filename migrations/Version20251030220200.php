...
final class Version20251030220200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_folders_name ON folders(name)');

        // Index for sorting/filtering by creation date
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_folders_created_at ON folders(created_at)');
    }
